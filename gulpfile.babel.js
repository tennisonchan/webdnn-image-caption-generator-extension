// generated on 2018-03-09 using generator-chrome-extension 0.6.1
...
gulp.task('babel', () => {
  const files = ['contentscript.js', 'background.js', 'chromereload.js'];
...
gulp.task('package', function() {
  ...
  return gulp
    .src('dist/**')
    .pipe($.zip('image caption extension-' + manifest.version + '.zip'))
